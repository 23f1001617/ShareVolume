...
> Your assigned company: Charles Schwab Corporation (SCHW), CIK 0000316709.

Fetch https://data.sec.gov/api/xbrl/companyconcept/CIK0000316709/dei/EntityCommonStockSharesOutstanding.json (set a descriptive User-Agent per SEC guidance).
...
`{"entityName": "Charles Schwab Corporation", "max": {"val": ..., "fy": ...}, "min": {"val": ..., "fy": ...}}`
